...
class TriangleTest {
    ...
    public void testGetNormal() {
        ...
        assertEquals(new Vector(new Point3D(sqrt3, sqrt3, sqrt3)),
    ...
    public void testfindIntersectionsRay() {
        ...
        // TC02: Against edge
        ray = new Ray(new Point3D(0, 0, -1), new Vector(new Point3D(1, 1, 0)));
        ...
        // TC03: Against vertex
        ray = new Ray(new Point3D(0, 0, 2), new Vector(new Point3D(-1, -1, 0)));
        ...
        // TC12: On edge
        ray = new Ray(new Point3D(-1, -1, 0), new Vector(new Point3D(1, 1, 0)));
