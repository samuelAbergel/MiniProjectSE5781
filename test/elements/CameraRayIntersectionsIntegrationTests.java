...
public class CameraRayIntersectionsIntegrationTests {
    ...
    public void cameraRaySphereIntegration() {
        Camera cam1 = new Camera.BuilderCamera(Point3D.ZERO, new Vector(new Point3D(0, 0, -1)), new Vector(new Point3D(0, -1, 0)))
                .build();
        Camera cam2 = new Camera.BuilderCamera(new Point3D(0, 0, 0.5), new Vector(new Point3D(0, 0, -1)), new Vector(new Point3D(0, -1, 0)))
                .build();
    ...
    public void cameraRayPlaneIntegration() {
        Camera cam = new Camera.BuilderCamera(Point3D.ZERO, new Vector(new Point3D(0, 0, -1)), new Vector(new Point3D(0, -1, 0)))
                .build();
